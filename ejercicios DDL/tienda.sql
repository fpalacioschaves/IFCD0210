...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-03-2022 a las 14:15:06
...
ALTER TABLE `compras`
  ...
  ADD KEY `fk_1` (`id_cliente`),
  ADD KEY `fk_2` (`id_producto`);
...
ALTER TABLE `compras`
  ...
  ADD CONSTRAINT `fk_2` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`);
